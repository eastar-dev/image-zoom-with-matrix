...
class ZoomStateView @JvmOverloads constructor(
    ...
    private fun drawPointInfo(canvas: Canvas, pointInfo: ArrayList<ZoomStateView.PointInfo>) {
    ...
    private fun drawDrawPointInfo(canvas: Canvas, drawPointInfo: ArrayList<ZoomStateView.DrawPointInfo>) {
